...
namespace Moamen_Sowlutions.Migrations
{
    ...
    [Migration("20250718074718_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.UserLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.UserVisibility", b =>
                {
                    b.HasOne("Entities.ApplicationUser", "AllowedUser")
                        .WithMany()
                        .HasForeignKey("AllowedUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Entities.ApplicationUser", "OwnerUser")
                        .WithMany()
